"""
Costa Farms Excel Formatter - Simplified & Stable
Clean formatting without Excel corruption issues
"""
...
def apply_costa_formatting(file_path: str) -> bool:
    """
    Apply clean Costa Farms formatting without causing Excel issues
    """
    ...
    try:
        ...
        # Costa Farms colors
        DEEP_GREEN = "2D5016"      # Header color
        MEDIUM_GREEN = "4A7C2C"     # Secondary
        LIGHT_GREEN = "E8F5E8"      # Light tint for alternating rows
        WHITE = "FFFFFF"
        LIGHT_GRAY = "F5F5F5"      # Alternating rows
        TOTAL_GRAY = "D9D9D9"       # Total rows
        ...
        title_font = Font(bold=True, size=12, color=DEEP_GREEN, name='Calibri')
        ...
        thick_bottom_border = Border(
            ...
            right=Side(style="thin", color="CCCCCC"),
            top=Side(style="thin", color="CCCCCC"),
            bottom=Side(style="medium", color=DEEP_GREEN)
        )
            ...
            for row_idx in range(section['data_start'], section['data_end'] + 1):
                ...
                if is_total_row:
                    ...
                    row_border = Border(
                        ...
                        top=Side(style="double", color="666666"),
                    ...
                    row_font = Font(size=10, name='Calibri')
        ...
        ws.oddHeader.center.text = "Costa Farms - Sourcing Analysis"
